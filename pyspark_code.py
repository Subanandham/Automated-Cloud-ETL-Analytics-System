...
## @type: DataSource
## @args: [database = "YOUR DB NAME", table_name = "YOUR TABLE NAME", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []

datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "YOUR DB NAME", table_name = "YOUR TABLE NAME", transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown)
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "YOUR CLEANED S3"}, format = "parquet", transformation_ctx = "datasink4"]
## @return: datasink4
...
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": "YOUR CLEANED S3", "partitionKeys": ["MENTION YOUR KEY"]}, format = "parquet", transformation_ctx = "datasink4")
